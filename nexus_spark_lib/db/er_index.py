...
async def upsert_batch(
    conn: asyncpg.Connection,
    entries: list[tuple[str, str, str, str, str, float, str, bool]],
    # (tenant_id, connector_id, source_table, source_record_id, cdm_entity_id, confidence, method, provisional)
) -> None:
    ...
    try:
        await conn.executemany(
            ...
            """,
            [
                (e[4], e[0], e[1], "", e[2], e[3], e[5], e[6], e[7])
                for e in entries
            ],
        )
